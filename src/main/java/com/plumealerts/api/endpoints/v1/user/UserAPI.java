...
public class UserAPI extends RoutingHandler {
    ...
    private Domain getDashboard(HttpServerExchange exchange) {
        ...
        List<DashboardRecord> dashboards = HandlerUser.findUserDashboard(userId);
    ...
    private Domain putDashboard(HttpServerExchange exchange) {
        ...
        try {
            ...
            DashboardTypes type = DashboardTypes.valueOf(dashboard.getType());
            if (!HandlerUser.updateDashboard(userId, type, dashboard)) {
