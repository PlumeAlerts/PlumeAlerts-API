...
public final class AccessTokenHandler {
    ...
    public static AccessTokenDomain generateTokens(String userId) throws JoseException {
    ...
    public static AccessTokenDomain generateTokens(String userId, NumericDate expiredAt, NumericDate refreshExpiredAt) throws JoseException {
        ...
        return new AccessTokenDomain(accessToken, refreshToken, expiredAt.getValue(), refreshExpiredAt.getValue());
    }
