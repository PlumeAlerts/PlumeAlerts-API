...
public class Indexes {
    ...
    public static final Index DASHBOARD_PKEY1 = Indexes0.DASHBOARD_PKEY1;
    ...
    public static final Index USER_PERMISSION_PKEY = Indexes0.USER_PERMISSION_PKEY;
    public static final Index USER_PERMISSION_PENDING_PKEY = Indexes0.USER_PERMISSION_PENDING_PKEY;
    ...
    private static class Indexes0 {
        public static Index DASHBOARD_PKEY1 = Internal.createIndex("dashboard_pkey1", Dashboard.DASHBOARD, new OrderField[]{Dashboard.DASHBOARD.CHANNEL_ID, Dashboard.DASHBOARD.USER_ID, Dashboard.DASHBOARD.TYPE}, true);
        public static Index DASHBOARD_PKEY = Internal.createIndex("dashboard_pkey", DashboardOld.DASHBOARD_OLD, new OrderField[]{DashboardOld.DASHBOARD_OLD.USER_ID, DashboardOld.DASHBOARD_OLD.TYPE}, true);
        ...
        public static Index USER_PERMISSION_PKEY = Internal.createIndex("user_permission_pkey", UserPermission.USER_PERMISSION, new OrderField[]{UserPermission.USER_PERMISSION.CHANNEL_ID, UserPermission.USER_PERMISSION.USER_ID, UserPermission.USER_PERMISSION.PERMISSION}, true);
        public static Index USER_PERMISSION_PENDING_PKEY = Internal.createIndex("user_permission_pending_pkey", UserPermissionPending.USER_PERMISSION_PENDING, new OrderField[]{UserPermissionPending.USER_PERMISSION_PENDING.CHANNEL_ID, UserPermissionPending.USER_PERMISSION_PENDING.USER_ID, UserPermissionPending.USER_PERMISSION_PENDING.PERMISSION}, true);
