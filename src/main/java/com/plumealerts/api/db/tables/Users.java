...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> LOGIN = createField("login", org.jooq.impl.SQLDataType.VARCHAR(25).nullable(false), this, "");

    /**
     * The column <code>public.users.display_name</code>.
     */
    public final TableField<UsersRecord, String> DISPLAY_NAME = createField("display_name", org.jooq.impl.SQLDataType.VARCHAR(25).nullable(false), this, "");

    /**
     * The column <code>public.users.broadcaster_type</code>.
     */
    public final TableField<UsersRecord, String> BROADCASTER_TYPE = createField("broadcaster_type", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.users.type</code>.
     */
    public final TableField<UsersRecord, String> TYPE = createField("type", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.users.view_count</code>.
     */
    public final TableField<UsersRecord, Long> VIEW_COUNT = createField("view_count", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.users.beta</code>.
     */
    public final TableField<UsersRecord, Boolean> BETA = createField("beta", org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
