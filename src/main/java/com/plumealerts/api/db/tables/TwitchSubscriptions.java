...
public class TwitchSubscriptions extends TableImpl<TwitchSubscriptionsRecord> {
    ...
    private static final long serialVersionUID = -573916205;
    ...
    /**
     * The column <code>public.twitch_subscriptions.channel_id</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> CHANNEL_ID = createField("channel_id", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.recipient_id</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> RECIPIENT_ID = createField("recipient_id", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.time</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, Timestamp> TIME = createField("time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.recipient_username</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> RECIPIENT_USERNAME = createField("recipient_username", org.jooq.impl.SQLDataType.VARCHAR(25).nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.recipient_display_name</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> RECIPIENT_DISPLAY_NAME = createField("recipient_display_name", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.sub_plan</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> SUB_PLAN = createField("sub_plan", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.cumulative_months</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, Integer> CUMULATIVE_MONTHS = createField("cumulative_months", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.streak_months</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, Integer> STREAK_MONTHS = createField("streak_months", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.context</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> CONTEXT = createField("context", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.message</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> MESSAGE = createField("message", org.jooq.impl.SQLDataType.CLOB, this, "");
    ...
    public List<ForeignKey<TwitchSubscriptionsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TwitchSubscriptionsRecord, ?>>asList(Keys.TWITCH_SUBSCRIPTIONS__TWITCH_SUBSCRIPTIONS_CHANNEL_ID_FKEY);
    }

    public Users users() {
        return new Users(this, Keys.TWITCH_SUBSCRIPTIONS__TWITCH_SUBSCRIPTIONS_CHANNEL_ID_FKEY);
    }
