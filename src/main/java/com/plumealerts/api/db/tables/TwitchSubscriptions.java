...
public class TwitchSubscriptions extends TableImpl<TwitchSubscriptionsRecord> {
    ...
    private static final long serialVersionUID = 939008199;
     ...
     */
    public final TableField<TwitchSubscriptionsRecord, String> CHANNEL_ID = createField(DSL.name("channel_id"), org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.recipient_id</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, String> RECIPIENT_ID = createField(DSL.name("recipient_id"), org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>public.twitch_subscriptions.time</code>.
     */
    public final TableField<TwitchSubscriptionsRecord, OffsetDateTime> TIME = createField(DSL.name("time"), org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE.nullable(false), this, "");
